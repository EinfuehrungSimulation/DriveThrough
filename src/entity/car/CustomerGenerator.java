...
public class CustomerGenerator{
	...
	/**
	 * Initialize different distributions to simulate peak times.
	 * create EntityAnimations and states.
	 * @param images : used to initialize the different states of the animation 
	 * @param hours : timespans where other distributions are used
	 * @param scales : scaling for the distributions
	 * @param mean 
	 * @param standardDeviation
	 */
	public CustomerGenerator(String[] images,int[] hours, double[] scales, double mean, double standardDeviation) {
		this.images = images;
		this.hours = hours;
		this.scales = scales;
		this.mean = mean;
		this.standardDeviation = standardDeviation;
		autoType = new Car("Auto",new State(CAR_NAME+0, CAR_NAME+0, images[0]));
	...
	/**
	 * Initializes statistics and other used distributions
	 * @param owner
	 */
	...
	/**
	 * @return timespan till next car will be produced
	 */
	...
	/**
	 * This event creates a new car and adds it to the counter
	 * @author sascha
	 *
	 */
	public class GeneratorEvet extends ExternalEvent{
		...
		public void eventRoutine() {
			...
			Customer auto = autoType.create(getDriveThrough());
